...
class Rossmann( object ):
    ...
    def data_cleaning( self, df1 ):
        '''
        A função recebe o sataset df1 e retorna df1 limpo. É o passo 1 do nosso projeto.
        '''
    ...
    def data_preparation( self, df5 ):
        '''
        Recebe o dataset df5, realiza todas as transformações e retorna um novo df5. É o passo 5 do nosso projeto.
        '''
